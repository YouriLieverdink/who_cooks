...
class NlIruoyWhocooksSchedulesV0ModelsSchedule extends Equatable {
  const NlIruoyWhocooksSchedulesV0ModelsSchedule(
      {required this.id,
      required this.date,
      required this.recipes,
      required this.days});

  factory NlIruoyWhocooksSchedulesV0ModelsSchedule.fromJson(dynamic json) {
    return NlIruoyWhocooksSchedulesV0ModelsSchedule(
        id: (json['id'] as String),
        date: DateTime.parse(json['date']),
        recipes: (json['recipes'] as List)
            .map((v) => NlIruoyWhocooksRecipesV0ModelsRecipe.fromJson(v))
            .toList(),
        days: (json['days'] as List).map((v) => (v as bool)).toList());
  }
  ...
  final List<NlIruoyWhocooksRecipesV0ModelsRecipe> recipes;
  ...
  dynamic toJson() {
    return {
      ...
      'days': days.map((v) => v).toList()
    };
  }

  @override
  List<Object?> get props {
    return [id, date, recipes, days];
  }

  NlIruoyWhocooksSchedulesV0ModelsSchedule copyWith(
      {String? id,
      DateTime? date,
...
class NlIruoyWhocooksSchedulesV0ModelsScheduleForm extends Equatable {
  const NlIruoyWhocooksSchedulesV0ModelsScheduleForm(
      {required this.date, required this.recipes, required this.days});

  factory NlIruoyWhocooksSchedulesV0ModelsScheduleForm.fromJson(dynamic json) {
    return NlIruoyWhocooksSchedulesV0ModelsScheduleForm(
        date: DateTime.parse(json['date']),
        recipes: (json['recipes'] as List)
            .map((v) => NlIruoyWhocooksRecipesV0ModelsRecipe.fromJson(v))
            .toList(),
  ...
  @override
  List<Object?> get props {
    return [date, recipes, days];
  }

  NlIruoyWhocooksSchedulesV0ModelsScheduleForm copyWith(
      {DateTime? date,
      List<NlIruoyWhocooksRecipesV0ModelsRecipe>? recipes,
      List<bool>? days}) {
    return NlIruoyWhocooksSchedulesV0ModelsScheduleForm(
...
typedef Schedule = NlIruoyWhocooksSchedulesV0ModelsSchedule;
typedef ScheduleForm = NlIruoyWhocooksSchedulesV0ModelsScheduleForm;
